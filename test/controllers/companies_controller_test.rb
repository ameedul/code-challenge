...
class CompaniesControllerTest < ApplicationSystemTestCase
  ...
  test 'Update' do
    ...
    assert_equal '93009', zip_code
    assert_equal ZipCodes.identify(zip_code).try(:[], :city), @company.city
    assert_equal ZipCodes.identify(zip_code).try(:[], :state_name), @company.state

  end

  test 'Create with incorrect details' do
    ...
    assert_text 'Please enter a valid US zip code'
  end

  test 'Create with correct details' do
    visit new_company_path
